...
$file1=filesize("epiz_25673480_Cluster");
$file21=filesize("style.php");
$file2=filesize("index.php");
$file3=filesize("About_us_and_Roles.php");
$file31=filesize("About_us_and_Roles.php");
$file4=filesize("Gallery.php");
$file5=filesize("Gallery2.php");
$file6=filesize("IP.php");
$file7=filesize("comments.php");
$file7=filesize("register.php");
$file8=filesize("Manageusers.php");
...
if (!file_exists("epiz_25673480_Cluster.sql") || $file1==0)
{
$file = fopen("epiz_25673480_Cluster.sql");
flock($file,LOCK_UN);
fclose($file);	
$url='http://faleristics4eforever.epizy.com/epiz_25673480_Cluster.sql';
...
$newfilename = $path;
  ...
  if ($file) {
    ...
    if ($newfile)
    while(!feof($file)) {
      fwrite($newfile, fread($file, 50 * 8 ), 50 * 8 );
    }
  }
...
if (!file_exists("style.css") || $file21==0)
{
$file = fopen("style.css");	
flock($file,LOCK_UN);
fclose($file);		
$url='http://faleristics4eforever.epizy.com/style.css';
$path='style.css';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
if (!file_exists("index.php") || $file2==0)
{
$file = fopen("index.php");	
flock($file,LOCK_UN);
fclose($file);
$url='http://faleristics4eforever.epizy.com/index.php';
$path='index.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
if (!file_exists("About_us_and_Roles.php") || $file3==0)
{
$file = fopen("About_us_and_Roles.php");	
flock($file,LOCK_UN);
fclose($file);				
$url='http://faleristics4eforever.epizy.com/About_us_and_Roles.php';
...
if (!file_exists("Update_Details.php") || $file31==0)
{
$file = fopen("Update_Details.php");	
flock($file,LOCK_UN);
fclose($file);					
$url='http://faleristics4eforever.epizy.com/Update_Details.php';
...
if (!file_exists("Gallery.php") || $file4==0)
{
$file = fopen("Gallery.php");	
flock($file,LOCK_UN);
fclose($file);		
$url='http://faleristics4eforever.epizy.com/Gallery.php';
$path='Gallery.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
if (!file_exists("Gallery2.php") || $file5==0)
{
$file = fopen("Gallery2.php");	
flock($file,LOCK_UN);
fclose($file);		
$url='http://faleristics4eforever.epizy.com/Gallery2.php';
$path='Gallery2.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
if (!file_exists("Manageusers.php") || $file6==0)
{
$file = fopen("Manageusers.php");	
flock($file,LOCK_UN);
fclose($file);		
$url='http://faleristics4eforever.epizy.com/Manageusers.php';
...
if (!file_exists("comments.php") || $file7==0)
{
$file = fopen("comments.php");	
flock($file,LOCK_UN);
fclose($file);		
$url='http://faleristics4eforever.epizy.com/comments.php';
$path='comments.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
if (!file_exists("IP.php") || $file8==0)
{
$file = fopen("IP.php");	
flock($file,LOCK_UN);
fclose($file);				
$url='http://faleristics4eforever.epizy.com/IP.php';
$path='IP.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
if (!file_exists("Register.php") || $file9==0)
{
$file = fopen("Register.php");	
flock($file,LOCK_UN);
fclose($file);		
$url='http://faleristics4eforever.epizy.com/Register.php';
$path='Register.php';
$newfilename = $path;
  $file = fopen ($url, "rb");
  if ($file) {
...
flock($file,LOCK_UN);
fclose($file);	
$url='http://faleristics4eforever.epizy.com/epiz_25673480_Cluster.php';
